...
public class Food {
   ...
   public static void demo() {
		...
		System.out.println("Welcome! to Your Restaurant"); //Print Welcome!.......Restaurant
		do {
			...
			System.out.println("\nEnter the number of the Desired Order:"); //Enter value
			f_type = scan.nextInt(); 
			switch (f_type) {
				...
				case 2 :
					...
					System.out.println("2:Butter Panner --- 180rs");
					System.out.println("3:Dal Makhani --- 210rs");
					System.out.println("4: Veg Biryani --- 250rs");
